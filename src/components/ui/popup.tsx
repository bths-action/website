...
> = ({ children, setOpen, title, disabledExit, size = "large" }) => {
  ...
  return (
    <div
      className="flex fixed inset-0 z-60 flex-row justify-center items-center w-dvw h-dvh bg-black/50"
    ...
    >
      <div
        className={`flex flex-col max-w-7xl max-h-[95dvh] xs:min-w-0 ${
